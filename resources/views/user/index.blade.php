            ...
            <nav id="navbar" class="navbar ">
                <ul class="">
                    ...
                    <ul class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                        ...
                        {{-- <li>
                            <a href="{{route('user', $item->id)}}">User</a>
                        </li> --}}
                        <li class="dropdown"><a href="#">
                                {{-- {{Auth::user()->nama_lengkap}} --}}
                                <span> user</span> <i class="bi bi-chevron-down"></i>
                                <img src="{{asset('dist/dashboard/assets/img/profile-img.jpg')}}" alt="" width="35px"
                                    height="35px" style="margin-left: 5px; border-radius:50%"></a>
                            <ul>

                                <li><a class="nav-link  scrollto" href="{{route('user', $item->id)}}">My Profile</a>
                                </li>
                                <li><a class="nav-link  scrollto" href="#pricing">Log Out</a></li>
                                {{-- <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <li><a class="dropdown-item" href="{{url('/')}}" :href="route('logout')" onclick="event.preventDefault();
                ...
                <section id="details" class="details">
                    <div class="container">
                        ...
                        <section id="alur" class="alur">
                            <div class="row content">
                                <div class="col-md-4" data-aos="fade-right">
                                    <img src="{{ asset('dist') }}/landing/assets/img/details-3.png" class="img-fluid "
                                        width="80%" alt="">
                                </div>
                ...
                <div class="container px-5">
                    <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                        ...
                        <div class="col-sm-9 col-md-6 mb-5">
                            <img class="" src="http://pmb.petikjombang.com/foto/Date.svg" height="80%" width="90%"
                                alt="">
                        </div>
                    </div>
                </div>
